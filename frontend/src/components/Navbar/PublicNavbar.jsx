            ...
            <div className="flex h-16 justify-between">
              <div className="flex">
                ...
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                  <Link
                    to="/"
                    className="relative inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-400 hover:bg-gradient-to-br hover:text-indigo-700 transition-colors duration-300 ease-in-out shadow-lg"
                  >
                    BudgetBuddy
                  </Link>
                </div>
